const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("TORNEO REGIONAL 2003");
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("CINTA DE CAMPEÓN");
const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("TORNEO NACIONAL 2003");
const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("COPA GLOBAL 2003");
const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("CINTA DE SUBCAMPEÓN");
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("CINTA DE SEMIFINALISTA");
const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("TORNEO REGIONAL 2004");
const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("TORNEO NACIONAL 2004");
const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("COPA GLOBAL 2004");
const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("TORNEO REGIONAL 2005");
const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("TORNEO NACIONAL 2005");
const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("COPA GLOBAL 2005");
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("COPA BATALLA POKéMON");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("CINTA de participación");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("LIGA POKéMON");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("COPA ADVANCE");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("Torneo POKéMON");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("CINTA de participación");
...
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("Superar dificultad");
const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("CINTA conmemorativa");
const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("CINTA otorgada por");
const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("superar todo el desafío.");
const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("100 victorias seguidas");
const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("TORRE OSCURIDAD completada");
const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("TORRE ROJA completada");
const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("TORRE HIERRO completada");
const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("TORRE FINAL completada");
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("Creando una leyenda");
...
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("CENTRO POKéMON NAGOYA");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("CENTRO POKéMON NY");
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("CINTA Vacaciones Verano");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("CINTA Vacaciones Invierno");
const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("CINTA Vacaciones Primavera");
const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("CINTA Siempreverde");
const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("CINTA Vacaciones Especial");
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("CINTA Trabajador");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("CINTA Muchos Amigos");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("CINTA Llena de Energía");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("Una CINTA conmemorativa");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("para un POKéMON querido.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("CINTA que demuestra");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("amor por los POKéMON.");
