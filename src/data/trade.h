...
static const u8 sText_SpaceMove[] = _(" MOVIDO"); // unused
...
static const u8 sText_IsThisTradeOkay[] = _("¿Está bien este cambio?");
static const u8 sText_Cancel[] = _("CANCELAR");
static const u8 sText_ChooseAPkmn[] = _("Elige un POKéMON.");
static const u8 sText_Summary[] = _("RESUMEN");
static const u8 sText_Trade[] = _("CAMBIO");
static const u8 sText_CancelTrade[] = _("¿Cancelar cambio?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("RESUMEN");
static const u8 sText_Trade2[] = _("CAMBIO");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Comunicación en espera…\nEspera, por favor.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}El intercambio ha\nsido cancelado.");
static const u8 sText_OnlyPkmnForBattle[] = _("Es tu único\nPOKéMON para luchar.");
