...
const u8 gEasyChatWord_Got[] = _("TIENE");
...
const u8 gEasyChatWord_Think[] = _("PIENSA");
...
const u8 gEasyChatWord_Gets[] = _("OBTIENE");
const u8 gEasyChatWord_Never[] = _("NUNCA");
...
const u8 gEasyChatWord_AllRight[] = _("MUY BIEN");
...
const u8 gEasyChatWord_Should[] = _("DEBERÍA");
