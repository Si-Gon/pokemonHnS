...
const u8 gEasyChatWord_UpsideDown[] = _("AL REVÉS");
...
const u8 gEasyChatWord_Much[] = _("MUCHO");
...
const u8 gEasyChatWord_Small[] = _("PEQUEÑO");
const u8 gEasyChatWord_Different[] = _("DIFERENTE");
...
const u8 gEasyChatWord_Nothing[] = _("NADA");
