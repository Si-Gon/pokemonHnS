...
const u8 gEasyChatWord_Come[] = _("VEN");
const u8 gEasyChatWord_Came[] = _("VINO");
const u8 gEasyChatWord_Search[] = _("SEARCH");
const u8 gEasyChatWord_Make[] = _("HACER");
const u8 gEasyChatWord_Cause[] = _("CAUSE");
const u8 gEasyChatWord_Know[] = _("SABER");
...
const u8 gEasyChatWord_Using[] = _("USANDO");
