...
const u8 gEasyChatWord_NotVery[] = _("NO MUY");
...
const u8 gEasyChatWord_The[] = _("EL");
const u8 gEasyChatWord_Miss[] = _("MISS");
const u8 gEasyChatWord_How[] = _("CÓMO");
...
const u8 gEasyChatWord_Only[] = _("SOLO");
const u8 gEasyChatWord_Around[] = _("ALREDEDOR");
...
const u8 gEasyChatWord_More[] = _("MÁS");
const u8 gEasyChatWord_TooLate[] = _("TARDE DEMAIS");
const u8 gEasyChatWord_Finally[] = _("FINALLY");
const u8 gEasyChatWord_Any[] = _("ALGÚN");
