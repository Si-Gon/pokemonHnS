...
const u8 gEasyChatWord_WhenIWin[] = _("CUANDO GANE");
const u8 gEasyChatWord_CantWin[] = _("NO PUEDES GANAR");
const u8 gEasyChatWord_CanWin[] = _("PUEDO GANAR");
...
const u8 gEasyChatWord_TakeThat[] = _("TOMA ESO");
const u8 gEasyChatWord_ComeOn[] = _("VAMOS");
const u8 gEasyChatWord_Attack[] = _("ATACAR");
...
const u8 gEasyChatWord_TooStrong[] = _("MUY FUERTE");
...
const u8 gEasyChatWord_Points[] = _("PUNTOS");
const u8 gEasyChatWord_Serious[] = _("SERIOUS");
const u8 gEasyChatWord_GiveUp[] = _("ME RINDO");
...
const u8 gEasyChatWord_TooWeak[] = _("MUY DÉBIL");
