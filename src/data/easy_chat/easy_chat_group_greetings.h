...
const u8 gEasyChatWord_HereGoes[] = _("ALLÁ VOY");
const u8 gEasyChatWord_HereICome[] = _("YA VOY");
const u8 gEasyChatWord_HereItIs[] = _("AQUÍ ESTÁ");
const u8 gEasyChatWord_Yeah[] = _("YEAH");
const u8 gEasyChatWord_Welcome[] = _("BIENVENIDO");
const u8 gEasyChatWord_Oi[] = _("OI");
const u8 gEasyChatWord_HowDo[] = _("CÓMO");
const u8 gEasyChatWord_Congrats[] = _("CONGRATS");
const u8 gEasyChatWord_GiveMe[] = _("DAME");
...
const u8 gEasyChatWord_HeyThere[] = _("¡EH, TÚ!");
const u8 gEasyChatWord_Hello[] = _("HOLA");
const u8 gEasyChatWord_GoodBye[] = _("ADIÓS");
const u8 gEasyChatWord_ThankYou[] = _("GRACIAS");
...
const u8 gEasyChatWord_WellThen[] = _("BUENO, ENTONCES");
...
const u8 gEasyChatWord_WhatsUpQues[] = _("¿QUÉ TAL?");
...
const u8 gEasyChatWord_ByeBye[] = _("ADIÓS");
const u8 gEasyChatWord_MeetYou[] = _("HASTA LUEGO");
...
const u8 gEasyChatWord_ComeOver[] = _("VEN AQUÍ");
