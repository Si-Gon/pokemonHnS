const u8 gEasyChatWord_KthxBye[] = _("LISTO, CHAU.");
const u8 gEasyChatWord_YesSirExcl[] = _("SÍ, SEÑOR.");
const u8 gEasyChatWord_AvantGarde[] = _("AVANT GARDE");
const u8 gEasyChatWord_Couple[] = _("COUPLE");
const u8 gEasyChatWord_MuchObliged[] = _("MUY AGRADECIDO");
...
const u8 gEasyChatWord_New[] = _("NUEVO");
...
const u8 gEasyChatWord_HipAnd[] = _("MODERNO Y");
