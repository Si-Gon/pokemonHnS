...
static const u8 LandmarkName_FlowerShop[] = _("FLORERÍA");
static const u8 LandmarkName_PetalburgWoods[] = _("BOSQUE DE PETALBURG");
static const u8 LandmarkName_MrBrineysCottage[] = _("CABAÑA DEL SR. BRINEY");
static const u8 LandmarkName_AbandonedShip[] = _("BARCO ABANDONADO");
static const u8 LandmarkName_SeashoreHouse[] = _("CASA DE LA COSTA");
static const u8 LandmarkName_SlateportBeach[] = _("PLAYA DE PORTALUCA");
static const u8 LandmarkName_CyclingRoad[] = _("CICLOVÍA");
static const u8 LandmarkName_NewMauville[] = _("VILLA MALVA");
static const u8 LandmarkName_TrickHouse[] = _("CASA TRUCO");
static const u8 LandmarkName_OldLadysRestShop[] = _("DESCANSO DE LA ANCIANA");
static const u8 LandmarkName_Desert[] = _("DESIERTO");
static const u8 LandmarkName_WinstrateFamily[] = _("FAMILIA WINSTRATE");
static const u8 LandmarkName_CableCar[] = _("TELEFÉRICO");
static const u8 LandmarkName_GlassWorkshop[] = _("TALLER DE VIDRIO");
static const u8 LandmarkName_WeatherInstitute[] = _("INSTITUTO METEOROLÓGICO");
static const u8 LandmarkName_MeteorFalls[] = _("CASCADA METEORO");
static const u8 LandmarkName_TunnelersRestHouse[] = _("DESCANSO DEL TUNELERO");
...
static const u8 LandmarkName_SafariZoneGate_SafariZoneEntrance[] = _("ENTRADA ZONA SAFARI");
static const u8 LandmarkName_MtPyre[] = _("MT. PIRAL");
static const u8 LandmarkName_ShoalCave[] = _("CUEVA DE LOS BANCOS");
static const u8 LandmarkName_SeafloorCavern[] = _("CAVERNA DEL FONDO MARINO");
static const u8 LandmarkName_GraniteCave[] = _("CUEVA GRANITO");
static const u8 LandmarkName_OceanCurrent[] = _("CORRIENTE OCEÁNICA");
static const u8 LandmarkName_BillsHouse[] = _("CASA DE BILL");
static const u8 LandmarkName_FieryPath[] = _("SENDERO ÍGNEO");
static const u8 LandmarkName_JaggedPass[] = _("PASO ESCARPADO");
static const u8 LandmarkName_SkyPillar[] = _("PILAR DEL CIELO");
static const u8 LandmarkName_BerryMastersHouse[] = _("CASA DEL MAESTRO BAYA");
static const u8 LandmarkName_IslandCave[] = _("CUEVA DE LA ISLA");
static const u8 LandmarkName_DesertRuins[] = _("RUINAS DEL DESIERTO");
static const u8 LandmarkName_ScorchedSlab[] = _("LOSA CHAMUSCADA");
static const u8 LandmarkName_AncientTomb[] = _("TUMBA ANTIGUA");
static const u8 LandmarkName_SealedChamber[] = _("CÁMARA SELLADA");
static const u8 LandmarkName_FossilManiacsHouse[] = _("CASA DEL MANÍACO FÓSIL");
static const u8 LandmarkName_HuntersHouse[] = _("CASA DEL CAZADOR");
static const u8 LandmarkName_MagmaHideout[] = _("GUARIDA MAGMA");
static const u8 LandmarkName_MirageTower[] = _("TORRE ESPEJISMO");
static const u8 LandmarkName_AlteringCave[] = _("CUEVA ALTERADORA");
static const u8 LandmarkName_DesertUnderpass[] = _("TÚNEL DEL DESIERTO");
static const u8 LandmarkName_TrainerHill[] = _("COLINA ENTRENADOR");
static const u8 LandmarkName_DracoChamber[] = _("CÁMARA DE DRACO");
static const u8 LandmarkName_CaveOfShock[] = _("CUEVA DEL IMPACTO");
