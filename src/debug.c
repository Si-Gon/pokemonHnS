...
static const u8 sDebugText_Continue[] =      _("Continuar…{CLEAR_TO 110}{RIGHT_ARROW}");
// Main Menu
static const u8 sDebugText_Utilities[] =        _("Utilidades…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Scripts[] =          _("Scripts…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_FlagsVars[] =        _("Banderas y Vars…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle[] =           _("Prueba Batalla…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Give[] =             _("Dar X…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_PkmCreator[] =       _("Creador Pokémon…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Fill[] =             _("Llenar PC/Bolsas…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Sound[] =            _("Sonido…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_AccessPC[] =         _("Acceder a PC…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Cancel[] =           _("Cancelar");
// Script menu
static const u8 sDebugText_Util_Script_1[] =               _("Abrir Menú Desafíos");
static const u8 sDebugText_Util_Script_2[] =               _("Cultivar árbol de bayas");
static const u8 sDebugText_Util_Script_3[] =               _("Info modo Nuzlocke");
static const u8 sDebugText_Util_Script_4[] =               _("Script 4 (Vacío)");
static const u8 sDebugText_Util_Script_5[] =               _("Script 5 (Vacío)");
static const u8 sDebugText_Util_Script_6[] =               _("Script 6 (Vacío)");
static const u8 sDebugText_Util_Script_7[] =               _("Script 7 (Vacío)");
static const u8 sDebugText_Util_Script_8[] =               _("Script 8 (Vacío)");
// Util Menu
static const u8 sDebugText_Util_HealParty[] =               _("Curar equipo");
static const u8 sDebugText_Util_Fly[] =                     _("Volar al mapa…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_WarpToMap[] =               _("Teletransporte al mapa…{CLEAR_TO 110}{RIGHT_ARROW}");
...
static const u8 sDebugText_Util_WarpToMap_SelectWarp[] =    _("Teletransp:{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_3}{CLEAR_TO 90}");
static const u8 sDebugText_Util_WarpToMap_SelMax[] =        _("{STR_VAR_1} / {STR_VAR_2}");
static const u8 sDebugText_Util_PoisonMons[] =              _("Envenenar todos los POKéMON");
static const u8 sDebugText_Util_SaveBlockSpace[] =          _("Espacio SaveBlock…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_Weather[] =                 _("Clima…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_Weather_ID[] =              _("ID Clima: {STR_VAR_3}\n{STR_VAR_1}\n{STR_VAR_2}");
static const u8 sDebugText_Util_CheckWallClock[] =          _("Ver reloj…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_SetWallClock[] =            _("Ajustar reloj…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_WatchCredits[] =            _("Ver créditos…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Util_Trainer_Name[] =            _("Nombre Entrenador");
static const u8 sDebugText_Util_Trainer_Gender[] =          _("Cambiar género");
static const u8 sDebugText_Util_Trainer_Id[] =              _("Nuevo ID Entrenador");
static const u8 sDebugText_Util_CheatStart[] =              _("Inicio TRUCO");
// Flags/Vars Menu
static const u8 sDebugText_FlagsVars_Flags[] =                  _("Activar Flag XYZ…{CLEAR_TO 110}{RIGHT_ARROW}");
...
static const u8 sDebugText_FlagsVars_PokedexFlags_All[] =       _("Banderas POKéDEX Todas");
static const u8 sDebugText_FlagsVars_PokedexFlags_Reset[] =     _("Banderas POKéDEX Reset");
static const u8 sDebugText_FlagsVars_PokedexFlags_Seen[] =       _("Banderas POKéDEX Vistos");
static const u8 sDebugText_FlagsVars_SwitchDex[] =              _("Cambiar {STR_VAR_1}POKéDEX");
static const u8 sDebugText_FlagsVars_SwitchNationalDex[] =      _("Cambiar {STR_VAR_1}NatDex");
static const u8 sDebugText_FlagsVars_SwitchPokeNav[] =          _("Cambiar {STR_VAR_1}PokéNav");
static const u8 sDebugText_FlagsVars_RunningShoes[] =           _("Cambiar {STR_VAR_1}Zapatos");
static const u8 sDebugText_FlagsVars_ToggleFlyFlags[] =         _("Cambiar {STR_VAR_1}Vuelo");
static const u8 sDebugText_FlagsVars_ToggleAllBadges[] =        _("Cambiar {STR_VAR_1}Todas las medallas");
static const u8 sDebugText_FlagsVars_ToggleFrontierPass[] =     _("Cambiar {STR_VAR_1}Pase Frontera");
static const u8 sDebugText_FlagsVars_BattleDmg[] =              _("Cambiar {STR_VAR_1}Daño Batalla OFF");
static const u8 sDebugText_FlagsVars_SwitchCollision[] =        _("Cambiar {STR_VAR_1}Colisión OFF");
static const u8 sDebugText_FlagsVars_SwitchEncounter[] =        _("Cambiar {STR_VAR_1}Encuentros OFF");
static const u8 sDebugText_FlagsVars_SwitchTrainerSee[] =       _("Cambiar {STR_VAR_1}Vista Entren. OFF");
static const u8 sDebugText_FlagsVars_SwitchBagUse[] =           _("Cambiar {STR_VAR_1}Uso Mochila OFF");
static const u8 sDebugText_FlagsVars_SwitchCatching[] =         _("Cambiar {STR_VAR_1}Captura OFF");
// Battle
static const u8 sDebugText_Battle_0_Wild[] =        _("Salvaje…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_0_WildDouble[] =  _("Doble salvaje…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_0_Single[] =      _("Sencillo…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_0_Double[] =      _("Doble…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_0_Mulit[] =       _("Múltiple…{CLEAR_TO 110}{RIGHT_ARROW}");
#ifndef BATTLE_ENGINE
static const u8 sDebugText_Battle_1_AIFlag_00[] =   _("{STR_VAR_1}Revisar mal movimiento");
static const u8 sDebugText_Battle_1_AIFlag_01[] =   _("{STR_VAR_1}Intentar debilitar");
static const u8 sDebugText_Battle_1_AIFlag_02[] =   _("{STR_VAR_1}Revisar viabilidad");
static const u8 sDebugText_Battle_1_AIFlag_03[] =   _("{STR_VAR_1}Preparar 1er turno");
static const u8 sDebugText_Battle_1_AIFlag_04[] =   _("{STR_VAR_1}Arriesgado");
static const u8 sDebugText_Battle_1_AIFlag_05[] =   _("{STR_VAR_1}Poder extremo");
static const u8 sDebugText_Battle_1_AIFlag_06[] =   _("{STR_VAR_1}Usa Relevo");
static const u8 sDebugText_Battle_1_AIFlag_07[] =   _("{STR_VAR_1}Combate doble");
static const u8 sDebugText_Battle_1_AIFlag_08[] =   _("{STR_VAR_1}Atento a PS");
static const u8 sDebugText_Battle_1_AIFlag_09[] =   _("{STR_VAR_1}Tentar Sol Soleado");
#else
static const u8 sDebugText_Battle_1_AIFlag_00[] =   _("{STR_VAR_1}Revisar mal movimiento");
static const u8 sDebugText_Battle_1_AIFlag_01[] =   _("{STR_VAR_1}Intentar debilitar");
static const u8 sDebugText_Battle_1_AIFlag_02[] =   _("{STR_VAR_1}Ver viabilidad");
static const u8 sDebugText_Battle_1_AIFlag_03[] =   _("{STR_VAR_1}Preparar 1er turno");
static const u8 sDebugText_Battle_1_AIFlag_04[] =   _("{STR_VAR_1}Arriesgado");
static const u8 sDebugText_Battle_1_AIFlag_05[] =   _("{STR_VAR_1}Preferir ataque fuerte");
static const u8 sDebugText_Battle_1_AIFlag_06[] =   _("{STR_VAR_1}Preferir Relevo");
static const u8 sDebugText_Battle_1_AIFlag_07[] =   _("{STR_VAR_1}Combate doble");
static const u8 sDebugText_Battle_1_AIFlag_08[] =   _("{STR_VAR_1}Atento a los PS");
static const u8 sDebugText_Battle_1_AIFlag_09[] =   _("{STR_VAR_1}Anula unaware");
static const u8 sDebugText_Battle_1_AIFlag_10[] =   _("{STR_VAR_1}Se suicidará");
static const u8 sDebugText_Battle_1_AIFlag_11[] =   _("{STR_VAR_1}Ayuda al aliado");
static const u8 sDebugText_Battle_1_AIFlag_12[] =   _("{STR_VAR_1}Prefiere estados");
static const u8 sDebugText_Battle_1_AIFlag_13[] =   _("{STR_VAR_1}Retrasar");
static const u8 sDebugText_Battle_1_AIFlag_14[] =   _("{STR_VAR_1}Pone pantallas");
static const u8 sDebugText_Battle_1_AIFlag_15[] =   _("{STR_VAR_1}Cambio inteligente");
static const u8 sDebugText_Battle_1_AIFlag_16[] =   _("{STR_VAR_1}POKéMON as");
#endif
static const u8 sDebugText_Battle_2_Terrain_0[] =   _("Hierba…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_1[] =   _("Hierba alta…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_2[] =   _("Arena…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_3[] =   _("Bajo el agua…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_4[] =   _("Agua…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_5[] =   _("Estanque…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_6[] =   _("Montaña…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_7[] =   _("Cueva…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_8[] =   _("Edificio…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Battle_2_Terrain_9[] =   _("Llanura…{CLEAR_TO 110}{RIGHT_ARROW}");
// Give Menu
static const u8 sDebugText_Give_GiveItem[] =            _("Dar objeto XYZ…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_ItemQuantity[] =             _("Cantidad:{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n\n{STR_VAR_2}");
static const u8 sDebugText_ItemID[] =                   _("ID Objeto: {STR_VAR_3}\n{STR_VAR_1}{CLEAR_TO 90}\n\n{STR_VAR_2}");
static const u8 sDebugText_Give_AllTMs[] =              _("Dar todas las MT");
static const u8 sDebugText_Give_GivePokemonSimple[] =   _("Pkm (nv)…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Give_GivePokemonComplex[] =  _("Pkm (n,s,n,a,IV,mov)…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_PokemonID[] =                _("Especie: {STR_VAR_3}\n{STR_VAR_1}{CLEAR_TO 90}\n\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonLevel[] =             _("Nivel:{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonShiny[] =             _("Variocolor:{CLEAR_TO 90}\n   {STR_VAR_2}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{CLEAR_TO 90}");
static const u8 sDebugText_PokemonNature[] =            _("Naturaleza: {STR_VAR_3}{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonAbility[] =           _("Habilidad: {STR_VAR_3}{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIVs[] =               _("Todos los IV:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIV_0[] =              _("IV PS:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIV_1[] =              _("IV Ataque:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIV_2[] =              _("IV Def:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIV_3[] =              _("IV Vel:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIV_4[] =              _("IV Atq. Esp:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonIV_5[] =              _("IV Def. Esp:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonMove_0[] =            _("Mov 0: {STR_VAR_3}{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonMove_1[] =            _("Mov 1: {STR_VAR_3}{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonMove_2[] =            _("Mov 2: {STR_VAR_3}{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_PokemonMove_3[] =            _("Mov 3: {STR_VAR_3}{CLEAR_TO 90}\n{STR_VAR_1}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_Give_MaxMoney[] =            _("Dinero Máx.");
static const u8 sDebugText_Give_MaxCoins[] =            _("Monedas Máx.");
static const u8 sDebugText_Give_BattlePoints[] =        _("Puntos Batalla Máx.");
static const u8 sDebugText_Give_DaycareEgg[] =          _("Huevo Guardería");
// Pokemon Creator
static const u8 sDebugText_PkmCreator_Party_Add[] =                 _("Añadir al Equipo");
static const u8 sDebugText_PkmCreator_Party_Edit[] =                _("Editar Equipo");
static const u8 sDebugText_PkmCreator_PC_Edit[] =                   _("Editar PC");
static const u8 sDebugText_PkmCreator_Enemy_Party_Edit[] =          _("Editar Enemigo");
static const u8 sDebugText_PkmCreator_Enemy_Party_Edit_Debug[] =    _("Edit. depurac. enemigo");
static const u8 sDebugText_PkmCreator_Debug_Edit[] =                _("Edit. depuración");
static const u8 sDebugText_PkmCreator_Enemy_Party_Add[] =           _("Añadir enemigo");
static const u8 sDebugText_PkmCreator_Testing[] =                   _("Pruebas");
static const u8 sDebugText_PkmCreator_Testing_Copy[] =              _("Pruebas (copia 1er mon)");
// Fill Menu
static const u8 sDebugText_Fill_Pc_Fast[] =        _("Llenar PC rápido");
static const u8 sDebugText_Fill_Pc_Slow[] =        _("Llenar PC lento (LAG!)");
static const u8 sDebugText_Fill_Pc_Items[] =       _("Llenar objetos PC");
static const u8 sDebugText_Fill_PocketItems[] =    _("Llenar Objetos");
static const u8 sDebugText_Fill_PocketPokeBalls[] =_("Llenar POKé BALL");
static const u8 sDebugText_Fill_PocketTMHM[] =     _("Llenar MT/MO");
static const u8 sDebugText_Fill_PocketBerries[] =  _("Llenar Bayas");
static const u8 sDebugText_Fill_PocketKeyItems[] = _("Llenar Objetos Clave");
// Sound Mneu
static const u8 sDebugText_Sound_SE[] =                 _("Efectos…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Sound_SE_ID[] =              _("Sonido Id: {STR_VAR_3}\n{STR_VAR_1}    \n{STR_VAR_2}");
static const u8 sDebugText_Sound_MUS[] =                _("Música…{CLEAR_TO 110}{RIGHT_ARROW}");
static const u8 sDebugText_Sound_MUS_ID[] =             _("ID de Música: {STR_VAR_3}\n{STR_VAR_1}    \n{STR_VAR_2}");

static const u8 sDebugText_PartyBoxes_HatchAnEgg[] =         _("Eclosionar Huevo");
...
static const u8 sWeatherNames[22][24] = {
    ...
    [WEATHER_SUNNY_CLOUDS]       = _("NUBES SOLEADAS"),
    [WEATHER_SUNNY]              = _("SOLEADO"),
    [WEATHER_RAIN]               = _("LLUVIA"),
    [WEATHER_SNOW]               = _("NIEVE"),
    [WEATHER_RAIN_THUNDERSTORM]  = _("LLUVIA TORMENTA"),
    [WEATHER_FOG_HORIZONTAL]     = _("NIEBLA HORIZ."),
    [WEATHER_VOLCANIC_ASH]       = _("CENIZA VOLCÁNICA"),
    [WEATHER_SANDSTORM]          = _("TORMENTA DE ARENA"),
    [WEATHER_FOG_DIAGONAL]       = _("NIEBLA DIAG."),
    [WEATHER_UNDERWATER]         = _("BAJO EL AGUA"),
    [WEATHER_SHADE]              = _("SOMBRA"),
    [WEATHER_DROUGHT]            = _("SEQUÍA"),
    [WEATHER_DOWNPOUR]           = _("LLUVIA TORRENCIAL"),
    [WEATHER_UNDERWATER_BUBBLES] = _("BURBUJAS SUBACUÁTICAS"),
    [WEATHER_ABNORMAL]           = _("ANORMAL(NO FUNCIONA)"),
    [WEATHER_ROUTE119_CYCLE]     = _("CICLO RUTA 119"),
    [WEATHER_ROUTE123_CYCLE]     = _("CICLO RUTA 123"),
};
static const u8 sText_WeatherNotDefined[] = _("¡¡¡NO DEFINIDO!!!");
static void DebugAction_Util_Weather(u8 taskId)
{
    u8 windowId;
